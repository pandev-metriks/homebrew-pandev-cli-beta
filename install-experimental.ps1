...
.DESCRIPTION
    ...
    Tokens replaced by the publish step (do NOT pre-fill them here):
      ...
      2d5507e77616be29eeb916796c6a8f373a77fed45f2debdde2f0baa57a48b23a  - checksum of the Windows .zip asset
      pandev-metriks/homebrew-pandev-cli-beta                  - repo whose GitHub release hosts the .zip
...
& {
    ...
    $VERSION = '2.4.12'
    $TAG = '@TAG@'
    $WINDOWS_AMD64_SHA256 = '2d5507e77616be29eeb916796c6a8f373a77fed45f2debdde2f0baa57a48b23a'
    ...
    # '2d5507e77616be29eeb916796c6a8f373a77fed45f2debdde2f0baa57a48b23a', but the publish step's str.replace runs
