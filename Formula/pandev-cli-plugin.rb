class PandevCliPlugin < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "00572c8e269ac0b97e63a671dffe42c1516087b39c5cb53d9fadaa0361ea5581"
    else
      ...
      sha256 "29b0e5e6c2f4e1d65c30ca128cfd645283ddf192f9f9036a5176cd4be43fe6ce"
    end
  end
  ...
  on_linux do
    ...
    sha256 "fec10d9f90ab1adcd608318243df34d94f0f3c2637d18abe8b7e8604c108f96a"
  end
