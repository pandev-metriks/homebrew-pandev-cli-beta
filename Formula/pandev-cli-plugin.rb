class PandevCliPlugin < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "3b91f396738cbbb6bc06417876c699fb04f839f0987ce0689abbe661c190ab40"
    else
      ...
      sha256 "db86a08ee95f22eb6b91a1a47b18d11581a75778273a697c4dc88865752ea1d0"
    end
  end
  ...
  on_linux do
    ...
    sha256 "6e1e407419c3137b227845dac179cc64a1ad7359e663402e711c24e4bf1b6eb2"
  end
