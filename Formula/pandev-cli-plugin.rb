class PandevCliPlugin < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "c49fc8ba1905201af41edd7438292f7567505bd2cde074f8dfede8cf02ca5f51"
    else
      ...
      sha256 "8311de9248350a45778cc861ac8f75cf3ab81b8d9db0db931d260dafad47c6cd"
    end
  end
  ...
  on_linux do
    ...
    sha256 "267809e7fa16aa254e98262a74a1fee1946e6ea2248d3f3ee9893778d9d7c345"
  end
