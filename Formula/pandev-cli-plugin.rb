class PandevCliPlugin < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "9d76b3cd728c9b31110380efdb300db287844427b571efb80283afb59a6c4dca"
    else
      ...
      sha256 "4f3cac09535ab8a472c5bfc10fab36930d35227366852f37b36b16473a8bafec"
    end
  end
  ...
  on_linux do
    ...
    sha256 "09178a6d9b722404b2d14073b4fc8eaa4af15f9fe0a080fbc842cbfb02cd97f1"
  end
