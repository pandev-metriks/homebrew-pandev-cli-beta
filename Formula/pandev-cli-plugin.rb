class PandevCliPlugin < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "960fa6ed74c1aba009b54729461cadd4db9e99bbc7661bacb3772264a6322e5d"
    else
      ...
      sha256 "f4a08b4b8efeed148305230f7f581897576c11832e6e36f1bfd838ec55a297b7"
    end
  end
  ...
  on_linux do
    ...
    sha256 "846a6c66fb005ecbc122cac7b354471e3a61cfee751b353a7625397b7d5c11d8"
  end
