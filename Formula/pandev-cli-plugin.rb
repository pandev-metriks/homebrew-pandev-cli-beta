class PandevCliPlugin < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "ce980f4fc205ffcb940420c874a3b972d1d4bd11f388a602d3f01cf6f3a0ed06"
    else
      ...
      sha256 "e8dfd7f3da3157f42affc8e8a36d1089a2d7f575776d5dd3e48a87f7e90d13fe"
    end
  end
  ...
  on_linux do
    ...
    sha256 "2df67d518b21480405b934eea513fc6fad77b6fd4079eba50244f377888f91e0"
  end
